...
.ps-tempRow{display:grid;grid-template-columns:auto auto minmax(72px,1fr);align-items:end;gap:8px;margin:10px 0 10px;overflow:hidden}.ps-temp{font-size:70px;font-weight:900;line-height:.9;color:inherit}.ps-unit{font-size:20px;color:#d7e5f5;padding-bottom:8px}.ps-temp-inline-spark{height:42px;min-width:0;color:#76d7ff;overflow:hidden;align-self:center}.ps-temp-inline-spark .sparkline{width:100%;height:42px;display:block;overflow:hidden}.ps-temp-inline-spark svg{max-width:100%;clip-path:inset(0)}
...
.ps-temp-spark{height:38px;margin:0 0 8px;color:#76d7ff;overflow:hidden}.ps-temp-spark .sparkline{height:38px;width:100%;overflow:hidden}.ps-metrics{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:auto}.ps-metric{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);border-radius:14px;padding:10px;min-height:94px;overflow:hidden}.ps-k{font-size:12px;color:inherit;opacity:.88;margin-bottom:6px;font-weight:700}.ps-kline{display:grid;grid-template-columns:auto minmax(0,1fr);gap:8px;align-items:center;height:30px;margin-bottom:2px;overflow:hidden}.ps-kline .ps-k{margin:0;white-space:nowrap}.ps-k-spark{height:28px;min-width:0;overflow:hidden}.ps-k-spark .sparkline{width:100%;height:28px;display:block;overflow:hidden}.ps-k-spark svg{max-width:100%;clip-path:inset(0)}.ps-v{font-size:26px;font-weight:900;line-height:1.1;color:#0f172a;display:flex;align-items:center;min-width:0}.ps-v.ps-wrap{font-size:13px;font-weight:700;line-height:1.2;word-break:break-word;overflow-wrap:anywhere;white-space:normal}.ps-s{font-size:11px;color:#e3edf9;margin-top:6px}.ps-hero .ps-v{color:#fff}.ps-chip{display:inline-flex;align-items:center;justify-content:center;padding:3px 8px;border-radius:999px;font-size:9px;font-weight:800;margin-top:6px}.ps-chip.good{background:#dcfce7;color:#166534}.ps-chip.warn{background:#fef3c7;color:#92400e}.ps-chip.bad{background:#fee2e2;color:#991b1b}.ps-chip.neutral{background:#e2e8f0;color:#334155}
...
(function(){
  ...
  async onReady() {
    try {
      this.log.info('[VIS] v0.3.44 Diagnose-Logging aktiv');
