...
.ps-header{display:grid;grid-template-columns:auto minmax(64px,1fr) auto;gap:7px;align-items:start}.ps-heading-main{display:contents}.ps-title{font-size:15px;font-weight:800;color:inherit;white-space:nowrap;min-width:0}.ps-header-spark{height:28px;min-width:64px;max-width:none;color:#76d7ff;overflow:hidden;align-self:center}.ps-header-spark .sparkline{width:100%;height:28px;display:block;overflow:hidden}.ps-header-spark svg{max-width:100%;clip-path:inset(0)}.ps-ver{font-size:8px;font-weight:800;color:#b9d7ff;margin-left:4px}.ps-sub{font-size:10px;color:#d4deec;text-align:right;white-space:nowrap}.ps-mode{display:inline-flex;align-items:center;justify-content:center;padding:3px 9px;border-radius:999px;border:1px solid rgba(255,255,255,.18);background:linear-gradient(180deg,#334f84,#1b3158);font-weight:800;font-size:11px;color:#fff;cursor:pointer}
...
(function(){
  ...
  async onReady() {
    try {
      this.log.info('[VIS] v0.3.43 Diagnose-Logging aktiv');
