...
<div class="ps-root"><div class="ps-grid">
  <div class="ps-card ps-hero">
    ...
    <div class="ps-tempRow"><div class="ps-temp">${esc(data.poolTemp)}</div><div class="ps-unit">°C</div><div class="ps-temp-inline-spark">${data.poolTempSparklineSvg || ''}</div></div>
