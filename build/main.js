...
.temp-history-24h path{fill:none!important;stroke:#39aef7!important;stroke-width:1!important;stroke-linecap:round!important;stroke-linejoin:round!important;opacity:1!important}
...
(function(){
  ...
  buildSparklineSvgFromValues(values, cssClass = '', timeMode = 'today') {
    ...
    const strokeWidth = cssClass === 'sparkline-temp' ? 1 : 2.6;
    return `<svg class="sparkline ${cssClass}" viewBox="0 0 ${w} ${h}" preserveAspectRatio="none" aria-hidden="true" focusable="false"><path d="${path}" fill="none" stroke="${strokeColor}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round"></path><circle cx="${r(last.x)}" cy="${r(last.y)}" r="1.8" fill="${strokeColor}"></circle></svg>`;
  }
